...
export default function Sidebar({projects, onProjectClick, selectedProject}: {
    ...
    return (
        <div
            className={"w-full sm:w-96 h-full p-12 pt-6 overflow-scroll overflow-x-hidden bg-gray-100 shadow-lg"}>
            ...
            <div
                className={"mt-10 grid grid-col gap-20 justify-center items-center relative"}>
